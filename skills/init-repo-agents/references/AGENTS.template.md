<!--
  ...
  - Section 0, "Session Lifecycle," is the highest-level behavioral constraint.
    Preserve it verbatim and do not compress it.
  ...
  - After rendering this template, mirror the same content to CLAUDE.md and keep
